...
Before you can use the example app, you will need a [Mapbox API access token](https://docs.mapbox.com/help/how-mapbox-works/access-tokens/), and must copy it into [mapbox_token.json](./example/mapbox_token.json).
