...
The `<GeometryEditorUI/>` graphical interface for the library accepts schema descriptions that the library uses to build forms so that the user can edit geometry metadata in a type-safe manner.
